...
import (
	...
	"github.com/FPesenda/backpack-bcgow6-franco-pesenda/GOWeb/C4_2/Swagger/pkg/web"
...
// Patch Products godoc
// @Sumary patch Products
// @Tags Products
// @Description update name and price of one product in the Data Base
// @Produce json
...
// @Sumary Delete Products
// @Tags Products
// @Description delete one product in the Data Base
// @Produce json
// @Param token header string true  "token"
// @Success 200 {object} web.Response
// @Router /products [get]
...
// GetAll Products godoc
// @Sumary Obtain all Products
// @Tags Products
// @Description obtain all products in the Base Data
// @Produce json
// @Param token header string true  "token"
// @Success 200 {object} web.Response
// @Router /products [get]
...
// Store Products godoc
// @Sumary Save Products
// @Tags Products
// @Description save one product in the Data Base
// @Produce json
// @Param token header string true  "token"
// @Success 200 {object} web.Response
...
// @Produce json
// @Param token header string true  "token"
// @Param producy body request true "product to update"
// @Success 200 {object} web.Response
// @Router /products [get]
