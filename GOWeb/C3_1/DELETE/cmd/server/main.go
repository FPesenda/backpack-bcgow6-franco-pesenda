...
import (
	"github.com/FPesenda/backpack-bcgow6-franco-pesenda/GOWeb/C3_1/DELETE/cmd/server/handler"
	"github.com/FPesenda/backpack-bcgow6-franco-pesenda/GOWeb/C3_1/DELETE/internal/products"
